...
function evaluate(node, env){
    switch (node.type){
        ...
        case "quote": return node.value
        case "syntaxquote": return evaluateSyntaxQuote(node, env)
        case "var": return evaluateVariable(node, env)
        ...
        case "macroexpansion": return evaluateMacroExpansion(node, env)
        case "application": return evaluateApplication(node, env)
    }
}
